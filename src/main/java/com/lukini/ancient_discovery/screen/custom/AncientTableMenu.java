...
public class AncientTableMenu extends AbstractContainerMenu {
    public final AncientTableBlockEntity blockEntity;
    private final Level level;

    public AncientTableMenu(int pContainerId, Inventory inv, FriendlyByteBuf extraData) {
        this(pContainerId, inv, inv.player.level().getBlockEntity(extraData.readBlockPos()));
    }

    public AncientTableMenu(int pContainerId, Inventory inv, BlockEntity blockEntity) {
        super(ModMenuTypes.ANCIENT_TABLE_MENU.get(), pContainerId);
        this.blockEntity = ((AncientTableBlockEntity) blockEntity);
    ...
    public boolean stillValid(Player pPlayer) {
        return stillValid(ContainerLevelAccess.create(level, blockEntity.getBlockPos()),
                pPlayer, ModBlocks.ANCIENT_TABLE.get());
    }
