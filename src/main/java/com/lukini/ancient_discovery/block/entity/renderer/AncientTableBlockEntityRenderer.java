package com.lukini.ancient_discovery.block.entity.renderer;
...
public class AncientTableBlockEntityRenderer implements BlockEntityRenderer<AncientTableBlockEntity> {

    public AncientTableBlockEntityRenderer(BlockEntityRendererProvider.Context context) {}

    @Override
    public void render(AncientTableBlockEntity pBlockEntity, float pPartialTick, PoseStack pPoseStack,
